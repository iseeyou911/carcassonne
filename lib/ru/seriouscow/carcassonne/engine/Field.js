...
dojo.declare('ru.seriouscow.carcassonne.engine.Field', [dijit._Widget, dijit._TemplatedMixin], {
    ...
    init : function (cards) {
        ...
        this.context2D = new Kinetic.Stage({
                container: this.field,
                width: box.w,
                height: box.h
            });
        //new Canvas(this.field, box.w, box.h);
        this.theGame = new ru.seriouscow.carcassonne.engine.GameController();


        var textures = {
            table : {src : '/resources/images/OM2j.png'},
        ...
        this.resourceLoader.getNewImageLoader().
            push(cards).
            push(textures.table).
            push(textures.placeHolder).
            push(textures.rotateArrow).
            push(textures.nextButton).load().then(function(){
